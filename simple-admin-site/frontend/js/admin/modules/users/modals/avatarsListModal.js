...
import {onClick_uploadOtherAvatar,
        onClick_chooseAvatarInModal,
        onClick_closeChooseAvatarDialog,        
        onClick_setUserAvatar} from 'handleEvents/userProfileHandleEvents';
...
``
                        <button className="btn btn-primary"
                                onClick={onClick_setUserAvatar.bind(this)}>{this.props.chooseText}</button>

                        <button className="btn btn-default"
                                onClick={onClick_closeChooseAvatarDialog.bind(this)}>{this.props.closeText}</button>
