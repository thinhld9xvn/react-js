...
class NewTextBlockModal extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            modal_id : MODALIDS.NEW_TEXT_BLOCK_MODAL_ID,
            instName : COMPONENTREFS.NEW_TEXT_BLOCK_COMPONENT_REF
        }
...
export default connect(mapStateToProps, mapDispatchToProps)(NewTextBlockModal);